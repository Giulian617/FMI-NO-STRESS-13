#! /bin/bash
./generator_spirala -N "10" -Q "10" -maxRep "1" -probInc "50" "dg73h1e98h" > ./tests/test_000.in
./phf < ./tests/test_000.in > ./tests/test_000.out

./generator_spirala -N "100" -Q "5" -maxRep "3" -probInc "0" "fkdfnei sbidn" > ./tests/test_001.in
./phf < ./tests/test_001.in > ./tests/test_001.out

./generator_spirala -N "5" -Q "100" -maxRep "1" -probInc "100" "fdaonfanbdun" > ./tests/test_002.in
./phf < ./tests/test_002.in > ./tests/test_002.out

./generator_spirala -N "100" -Q "100" -maxRep "5" -probInc "20" "d;adnfba/ f" > ./tests/test_003.in
./phf < ./tests/test_003.in > ./tests/test_003.out

./generator_spirala -N "500" -Q "500" -maxRep "1" -probInc "60" "dfkanourwr" > ./tests/test_004.in
./phf < ./tests/test_004.in > ./tests/test_004.out

./generator_spirala -N "1234" -Q "1234" -maxRep "1" -probInc "56" "d19yu4801hdb" > ./tests/test_005.in
./phf < ./tests/test_005.in > ./tests/test_005.out

./generator_spirala -N "2000" -Q "5000" -maxRep "1" -probInc "40" "dpnqebfownd" > ./tests/test_006.in
./phf < ./tests/test_006.in > ./tests/test_006.out

./generator_spirala -N "5000" -Q "2000" -maxRep "2" -probInc "33" "dsanfjabedon" > ./tests/test_007.in
./phf < ./tests/test_007.in > ./tests/test_007.out

./generator_spirala -N "5000" -Q "5000" -maxRep "1" -probInc "40" "fee;aefob" > ./tests/test_008.in
./phf < ./tests/test_008.in > ./tests/test_008.out

./generator_spirala -N "5000" -Q "5000" -maxRep "1" -probInc "40" "lajnfjba casdasd" > ./tests/test_009.in
./phf < ./tests/test_009.in > ./tests/test_009.out

./generator_spirala -N "5000" -Q "5000" -maxRep "1" -probInc "40" "135y38hen7913y" > ./tests/test_010.in
./phf < ./tests/test_010.in > ./tests/test_010.out

./generator_spirala -N "10000" -Q "10000" -maxRep "1" -probInc "50" "dfofkjjbfouohasddf" > ./tests/test_011.in
./phf < ./tests/test_011.in > ./tests/test_011.out
