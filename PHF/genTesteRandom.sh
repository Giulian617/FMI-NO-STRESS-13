#! /bin/bash
./generator_random -N "10" -Q "10" "dg73h1e98h" > ./tests/test_300.in
./phf < ./tests/test_300.in > ./tests/test_300.out

./generator_random -N "100" -Q "5" "fkdfnei sbidn" > ./tests/test_301.in
./phf < ./tests/test_301.in > ./tests/test_301.out

./generator_random -N "5" -Q "100" "fdaonfanbdun" > ./tests/test_302.in
./phf < ./tests/test_302.in > ./tests/test_302.out

./generator_random -N "100" -Q "100" "d;adnfba/ f" > ./tests/test_303.in
./phf < ./tests/test_303.in > ./tests/test_303.out

./generator_random -N "1234" -Q "1234" "d19yu4801hdb" > ./tests/test_304.in
./phf < ./tests/test_304.in > ./tests/test_304.out
