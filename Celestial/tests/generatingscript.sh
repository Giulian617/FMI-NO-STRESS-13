...
if [[ "../src/Marius" -nt "$executable" ]]; then
    echo "Solution is newer than the executable. Recompile needed."
    g++ -std=c++17 -Wall -fsanitize=address,undefined,signed-integer-overflow -O2 ../src/Marius.cpp -o ../src/bin/Marius
...
do
    ...
    ../src/bin/Marius < Subtask_$subtask/input_${subtask}_$test.in > Subtask_$subtask/output_${subtask}_$test.out
done
