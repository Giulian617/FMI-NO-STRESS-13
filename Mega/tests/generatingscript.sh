...
if [[ "../src/solution_full" -nt "$executable" ]]; then
    echo "Solution is newer than the executable. Recompile needed."
    g++ -std=c++17 -Wall -fsanitize=address,undefined,signed-integer-overflow -O2 ../src/solution_full.cpp -o ../src/solution_full
...
do
    ...
    ../src/solution_full < Subtask_$subtask/input_${subtask}_$test.in > Subtask_$subtask/output_${subtask}_$test.out
done
